...
function drawReactieWoord(){
	...
	if (telefoonBoolean == true && opAuto == false )
	{
		  ...
		  canvasContext.strokeStyle = 'black';
          canvasContext.fillText(" REACTIE"   ,muisX - 100 , muisY);
          canvasContext.strokeText(" REACTIE" ,muisX - 100, muisY);
	}
}
...
function drawBackground() {
	//teken achtergrond
		if(autoCrash == false){
			...
			{
				achtergrondX = 0;
				//console.log('achtergrond1x');
			}

			if (achtergrondX2 < -2801 )
			{
				achtergrondX2 = 1401;
				//console.log('achtergrond2x');
			}
		}
...
function scoreDisplay() {
						...
						canvasContext.beginPath();
   						canvasContext.rect(15, 10, 250, 50);
    					canvasContext.fillStyle = 'white';
     					canvasContext.fill();
